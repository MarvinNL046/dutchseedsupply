...
export const NewsletterSection = () => {
  ...
  const benefits = [
    ...
    { icon: 'science', text: 'Cannabis cultivation tips and education' },
    { icon: 'tips_and_updates', text: 'Growing advice and strain information' },
  ];
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-0 shadow-lg p-8 rounded-xl">
              {status === 'success' ? (
                ...
                <>
                  ...
                  <p className="text-white/80 mb-6">
                    Get the latest cannabis strains, growing tips, and special offers delivered directly to your inbox.
                  </p>
