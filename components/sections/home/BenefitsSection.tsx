...
/**
 * Modern benefits of cannabis seeds section for the homepage
 */
  ...
  const benefits = [
    {
      id: 'genetics',
      icon: 'dna',
      title: t.benefits.genetics,
      description: t.benefits.geneticsDesc,
    ...
    },
    {
      id: 'germination',
      icon: 'eco',
      title: t.benefits.germination,
      description: t.benefits.germinationDesc,
    ...
    },
    {
      ...
      description: t.benefits.selectionDesc,
    ...
    <section className="py-20 bg-white relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container-custom">
        <div className="flex flex-col items-center mb-16">
          <Badge variant="outline" className="mb-4">Why Choose Our Seeds</Badge>
          ...
          <p className="mt-4 text-center text-gray-600 max-w-2xl">
            Discover the advantages of our premium cannabis seeds, carefully selected for quality, potency, and reliability.
          </p>
        </div>
        ...
        <div className="mt-16 flex justify-center">
          <div className="bg-white/80 backdrop-blur-sm shadow-md rounded-full py-3 px-6 flex items-center border border-accent">
            ...
            <span className="text-sm font-medium">Premium quality seeds with guaranteed genetics and high germination rates</span>
          </div>
        </div>
      </div>
    </section>
