  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      text: 'The Northern Lights seeds had an amazing germination rate. All 5 seeds sprouted within 48 hours and grew into healthy plants with impressive yields.',
      product: 'Northern Lights Feminized Seeds (5-pack)'
    },
    {
      id: '2',
      name: 'Maria Garcia',
      ...
      rating: 5,
      text: 'As a first-time grower, I was nervous about trying autoflowering seeds, but they were so easy to grow! The plants were resilient and the harvest exceeded my expectations.',
      product: 'Blueberry Auto Seeds (3-pack)'
    },
    {
      id: '3',
      name: 'Jan Kowalski',
      ...
      rating: 4,
      text: 'The CBD-rich seeds produced plants with exactly the therapeutic profile I was looking for. Much milder effect with all the medicinal benefits. Will definitely order again.',
      product: 'CBD Kush Feminized Seeds (10-pack)'
    }
  ];
