...
/**
 * Modern How Cannabis Plants Grow section for the homepage with interactive cards
 */
  ...
  const steps = [
    {
      ...
      icon: 'spa',
      title: 'Germination',
      description: 'Seeds sprout in 1-5 days under optimal conditions (21-25°C), developing a taproot that anchors the plant and absorbs nutrients.',
    ...
    },
    {
      ...
      description: 'Plants develop strong stems and fan leaves, growing rapidly for 3-16 weeks depending on strain and growing conditions.',
    ...
    },
    {
      ...
      description: 'Triggered by light cycle changes (or automatically in autoflowers), plants develop resin-rich buds over 7-12 weeks.',
    ...
    },
    {
      ...
      icon: 'agriculture',
      title: 'Harvest',
      description: 'When trichomes reach optimal maturity, plants are harvested, dried, and cured to preserve cannabinoids and terpenes.',
    ...
    <section className="py-20 bg-white relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container-custom">
        <div className="flex flex-col items-center mb-16">
          <Badge variant="outline" className="mb-4">Growers Guide</Badge>
          ...
          <p className="mt-4 text-center text-gray-600 max-w-2xl">
            Understanding the lifecycle of cannabis plants helps you become a more successful grower
          </p>
        </div>
        ...
        <div className="mt-12 flex justify-center">
          <div className="bg-white/80 backdrop-blur-sm shadow-md rounded-full py-3 px-6 flex items-center border border-accent">
            ...
            <span className="text-sm font-medium">Based on expert growing techniques and botanical science</span>
          </div>
        </div>
      </div>
    </section>
